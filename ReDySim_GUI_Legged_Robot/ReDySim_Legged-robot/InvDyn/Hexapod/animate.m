...
%     plot3(L1Z(i,:),-L1X(i,:),L1Y(i,:),'r',L2Z(i,:),-L2X(i,:),L2Y(i,:),'b',L3Z(i,:),-L3X(i,:),L3Y(i,:),'b',L4Z(i,:),-L4X(i,:),L4Y(i,:),'r',L5Z(i,:),-L5X(i,:),L5Y(i,:),'r',L6Z(i,:),-L6X(i,:),L6Y(i,:),'b','linewidth',3);
    ...
    hold on;
%     fill3(BZ(i,:),-BX(i,:),BY(i,:),[1 1 1 1 1 1 1])
