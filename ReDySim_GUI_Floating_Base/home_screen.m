...
% Last Modified by GUIDE v2.5 22-Apr-2018 19:22:57
...
%     type = type;
    ...
    uisave({ 'n', 'nq', 'alp', 'a', 'b', 'bt', 'dx', 'dy', 'dz', 'al', 'alt', 'm', 'g',  'Icxx', 'Icyy', 'Iczz', 'Icxy', 'Icyz', 'Iczx'},'inputs');
  
%   save inputs.mat n nq alp a b bt dx dy dz al alt m g  Icxx Icyy Iczz Icxy Icyz Iczx
...
function[]=plot_Base_COM_Float_For(handles)
disp('------------------------------------------------------------------');
disp('Generating plots for joint motions');
...
% h=legend('\tau_1','\tau_2','\tau_3','\tau_4','\tau_5','\tau_6','\tau_7','\tau_8','\tau_9','\tau_{10}','\tau_{11}','\tau_{12}');
set(h,'Orientation','h','Color', 'none','Box', 'off','Location','south','FontAngle','italic','fontsize',10,'fontweight','normal','fontname','times new romans','linewidth',0.5)
xlabel('time(s)','FontSize',10);
...
function[]=plot_Base_Euler_Float_For(handles)
disp('------------------------------------------------------------------');
disp('Generating plots for joint motions');
...
function[]=plot_Rate_Base_COM_Float_For(handles)
disp('------------------------------------------------------------------');
disp('Generating plots for joint motions');
...
function[]=plot_Rate_Base_Euler_Float_For(handles)
disp('------------------------------------------------------------------');
disp('Generating plots for joint motions');
...
function[]=plot_Joint_angle_Float_For(handles)
disp('------------------------------------------------------------------');
disp('Generating plots for joint motions');
...
function[]=plot_Rate_Joint_angle_Float_For(handles)
disp('------------------------------------------------------------------');
disp('Generating plots for joint motions');
...
function [] = plot_tor_Float_For(handles)
disp('------------------------------------------------------------------');
...
function[]=plot_Linear_mtum_Float_For(handles)
disp('------------------------------------------------------------------');
...
function[]=plot_Angular_mtum_Float_For(handles)
disp('------------------------------------------------------------------');
disp('Plotting total linear and angular momentum');
...
function[]=plot_Potential_en_Float_For(handles)
disp('------------------------------------------------------------------');
...
% set(h,'Orientation','horizontal','Color', 'none','Box', 'off','Location','best','fontsize',10,'fontweight','n','fontname','times new romans','linewidth',0.5)
 ...
 function[]=plot_Kinetic_en_Float_For(handles)
disp('------------------------------------------------------------------');
disp('Plots the Energy balance');
...
function[]=plot_Base_COM_Float_Inv(handles)
disp('------------------------------------------------------------------');
disp('Generating plots for joint motions');
...
function[]=plot_Base_Euler_Float_Inv(handles)
disp('------------------------------------------------------------------');
disp('Generating plots for joint motions');
...
function[]=plot_Rate_Base_COM_Float_Inv(handles)
disp('------------------------------------------------------------------');
disp('Generating plots for joint motions');
...
function[]=plot_Rate_Base_Euler_Float_Inv(handles)
disp('------------------------------------------------------------------');
disp('Generating plots for joint motions');
...
function[]=plot_Joint_angle_Float_Inv(handles)
disp('------------------------------------------------------------------');
disp('Generating plots for joint motions');
...
function[]=plot_Rate_Joint_angle_Float_Inv(handles)
disp('------------------------------------------------------------------');
disp('Generating plots for joint motions');
...
function[]=plot_tor_Float_Inv(handles)
disp('------------------------------------------------------------------');
...
function[]=plot_Linear_mtum_Float_Inv(handles)
disp('------------------------------------------------------------------');
disp('Plotting total linear and angular momentum');
...
function[]=plot_Angular_mtum_Float_Inv(handles)
disp('------------------------------------------------------------------');
disp('Plotting total linear and angular momentum');
...
function[]=plot_Potential_en_Float_Inv(handles)
disp('------------------------------------------------------------------');
disp('Plots the Energy balance');
...
function[]=plot_Kinetic_en_Float_Inv(handles)
disp('------------------------------------------------------------------');
disp('Plots the Energy balance');
...
% analysis_type1 = 'InvDyn';
if selectedIndex  == 1
      plot_Base_COM_Float_For(handles);
end
if selectedIndex  == 2
      plot_Base_Euler_Float_For(handles);
end
if selectedIndex  == 3
      plot_Rate_Base_COM_Float_For(handles);
end
if selectedIndex  == 4
      plot_Rate_Base_Euler_Float_For(handles);
end
if selectedIndex  == 5
      plot_Joint_angle_Float_For(handles);
end
if selectedIndex  == 6
      plot_Rate_Joint_angle_Float_For(handles);
end
if selectedIndex  == 7
      plot_tor_Float_For(handles);
end
if selectedIndex  == 8
      plot_Linear_mtum_Float_For(handles);
end
if selectedIndex  == 9
      plot_Angular_mtum_Float_For(handles);
end
if selectedIndex  == 10
      plot_Potential_en_Float_For(handles); 
end
if selectedIndex  == 11
      plot_Kinetic_en_Float_For(handles); 
end
...
if selectedIndex  == 1
      plot_Base_COM_Float_Inv(handles);
end
if selectedIndex  == 2
      plot_Base_Euler_Float_Inv(handles);
end
if selectedIndex  == 3
      plot_Rate_Base_COM_Float_Inv(handles);
end
if selectedIndex  == 4
      plot_Rate_Base_Euler_Float_Inv(handles);
end
if selectedIndex  == 5
      plot_Joint_angle_Float_Inv(handles);
end
if selectedIndex  == 6
      plot_Rate_Joint_angle_Float_Inv(handles);
end
if selectedIndex  == 7
      plot_tor_Float_Inv(handles);
end
if selectedIndex  == 8
      plot_Linear_mtum_Float_Inv(handles);
end
if selectedIndex  == 9
      plot_Angular_mtum_Float_Inv(handles);
end
if selectedIndex  == 10
      plot_Potential_en_Float_Inv(handles); 
end
if selectedIndex  == 11
      plot_Kinetic_en_Float_Inv(handles); 
end
