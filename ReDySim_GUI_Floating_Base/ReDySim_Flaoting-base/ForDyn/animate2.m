...
%         dth=Y(i,nqn+6-1:2*(n+6-1))';
         th=[0;0.3803;   -0.6198;    1.2867;    2.4411;    1.7062;   -1.0058];%60
         dth=zeros(n,1);
...
%     plot3(L1X(i,:),L1Y(i,:),L1Z(i,:),L2X(i,:),L2Y(i,:),L2Z(i,:),'linewidth',3);
    plot3(L1X(i,:),L1Y(i,:),L1Z(i,:),'.-',L2X(i,:),L2Y(i,:),L2Z(i,:),'.-','Color',[0.15 0.32 0.26],'MarkerSize',25,'linewidth',4);
    hold on;
...
%         BX(i,[3,4,5,6]),BY(i,[3,4,5,6]),BZ(i,[3,4,5,6]),[4 4 4 4]);
    ...
    set (gca,'fontsize',10,'fontweight','normal','fontname','times new romans','linewidth',0.5,'Box', 'on','BoxStyle', 'full','TickDir','out' );
