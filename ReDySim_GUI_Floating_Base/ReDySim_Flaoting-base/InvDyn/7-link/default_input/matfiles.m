...
%Link Length
al=[2; 0.35; 0.2; 0.87; 0.63; 0.36; 0.55; 0.532];
% %Distance from origin to link tip in term of link length
alt=[1; 0.35; 0.2; 0.87; 0.63; 0.36; 0.55; 0.532];
...
az=[ -2 ; b(3)*cos(alp(3));  b(4)*cos(alp(4));  b(5)*cos(alp(5)) ; b(6)*cos(alp(6));  b(7)*cos(alp(7));  b(8)*cos(alp(8));  0];
dx=ax/2;
dy=ay/2;
dz=az/2;
