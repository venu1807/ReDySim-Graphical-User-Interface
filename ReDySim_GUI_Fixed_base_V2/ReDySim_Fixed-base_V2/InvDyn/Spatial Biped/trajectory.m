function [thh,dthh,ddthh]=trajectory(tim,dof,Tp)

k=tim;
%Trejectories
Ts=0.5;  %time interval for one step
...
% for ti=0:step:Tfi
   ...
   %Hip trajectory generation
    ...
    %th2
    th6=pi; dth6=0; ddth6=0;
    %th1
%     alp1=atan2(yt2-yh,zh);
%     dalp1=(dyt2-dyh)*cos(alp1)*cos(alp1)/zh;
%     ddalp1=((ddyt2-ddyh)*cos(alp1)*cos(alp1)/zh)-2*tan(alp1)*dalp1;
    alp1=-atan2((yh-yt2),(zh-zt2));
    dalp1=-((dyh-dyt2+dzt2*tan(alp1))*cos(alp1)*cos(alp1))/(zh-zt2);
    ddalp1=-(((ddyh-ddyt2+ddzt2*tan(alp1))*cos(alp1)*cos(alp1)+2*dzt2*dalp1)/(zt2-zh))-2*tan(alp1)*dalp1;
    ...
    %th3
    th4=-(alp4-(gama1+bita1));
    dth4=-(dalp4-(dgama1+dbita1));
    ddth4=-(ddalp4-(ddgama1+ddbita1));
    %th5
    th1=-(bita1+gama1);
    dth1=-(dbita1+dgama1);
    ddth1=-(ddbita1+ddgama1);

    %Leg 2
    %th8
    th7=0; dth7=0; ddth7=0;
    %th7
%     alp7=atan2(yh-yt1,zh);
%     dalp7=(dyh-dyt1)*cos(alp7)*cos(alp7)/zh;
%     ddalp7=((ddyh-ddyt1)*cos(alp7)*cos(alp7)/zh)-2*tan(alp7)*dalp7;
 alp7=-atan2((yh-yt1),(zh-zt1));
    dalp7=-((dyh-dyt1+dzt1*tan(alp7))*cos(alp7)*cos(alp7))/(zh-zt1);
    ddalp7=-(((ddyh-ddyt1+ddzt1*tan(alp7))*cos(alp7)*cos(alp7)+2*dzt1*dalp7)/(zt1-zh))-2*tan(alp7)*dalp7;
...
% end
% ti=0:step:Tfi;
thh=[thh1; thh2; thh3; thh4; thh5; thh6; thh7; thh8; thh9; thh10; thh11; thh12];
dthh=[dthh1; dthh2; dthh3; dthh4; dthh5; dthh6; dthh7; dthh8; dthh9; dthh10; dthh11; dthh12];
ddthh=[ddthh1; ddthh2; ddthh3; ddthh4; ddthh5; ddthh6; ddthh7; ddthh8; ddthh9; ddthh10; ddthh11; ddthh12];
